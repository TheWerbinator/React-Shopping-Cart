...
class Checkout extends React.Component {
  state = {
    ...
    lastFour: "",
    cardType: "VISA",
    customerEmails: [{ email: "jon@jon.com", password: "asdf123!" }],
  };
  ...
  handleShipping = (type) => {
    ...
    type === "Express"
      ? this.setState({ total: this.state.subtotal - this.state.discount + 5 })
  ...
  handleTotals = (index) => {
    ...
    this.setState({
      total: this.state.subtotal - this.state.discount + this.state.shipping,
    });
  };
